...
## Show objects
objects <- gcs_list_objects(bucket = "hotspotstoplight_landcoverchange")


# download the file to given location, you can see the index of the files from previous step.
gcs_get_object(objects$name[[3]], saveToDisk = "data/fileName.RData")
```
