...
```{r LoadAndPrep}
library(lulcc)
load("/Users/oliveratwood/Documents/GitHub/HotspotStoplight/UrbanExpansion/data/cropped/LandCover.Rdata")
load("/Users/oliveratwood/Documents/GitHub/HotspotStoplight/UrbanExpansion/data/cropped/Factors.Rdata")
...
dmd <- approxExtrapDemand(obs=obs, tout=0,10)
```
...
#   Urban = c(urban_area_at_0, urban_area_at_10)
# )
```
