...
# Crop51 is the largest cropbox that can be used for the land cover change prediction on OA's Macbook
...
```
```{r}
# lc_2013[] <- as.integer(lc_2013[])
# lc_2023[] <- as.integer(lc_2023[])
```
...
reclassify_raster <- function(raster_layer) {wawaw
