...
lc_2013_ordered <- ordered.model@output[[1]]
lc_2023_ordered <- ordered.model@output[[2]]
...
lc_2023_ordered <- reclassify(lc_2023_ordered, reclass_matrix)
...
unique(lc_2023_ordered)

# Plotting with rasterVis
levelplot(lc_2013_ordered,
          col.regions=colorRampPalette(c("darkgreen", "tan", "red", "blue")),
