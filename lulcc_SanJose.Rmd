...
```{r LoadAndPrep}
# load("/Users/oliveratwood/Documents/GitHub/HotspotStoplight/LandCoverChange/data/cropped/crop5_60m/LandCover.Rdata")
# load("/Users/oliveratwood/Documents/GitHub/HotspotStoplight/LandCoverChange/data/cropped/crop5_60m/Factors.Rdata")

# # LandCover
# url <- "https://github.com/HotspotStoplight/LandCoverChange/raw/main/data/cropped/LandCover.RData"
...
# # Factors
# url <- "https://github.com/HotspotStoplight/LandCoverChange/raw/main/data/cropped/Factors.RData"
...
writeRaster(clues_output, filename="clues_output_2050.tif", format="GTiff", overwrite=TRUE)
...
clues.tabs <- ThreeMapComparison(x=clues.model@output,
                                   factors=2^(1:8),
                                   timestep=10)
```
